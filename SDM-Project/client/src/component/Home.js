  ...
  render() {
    if (!this.state.web3) {
      return (
        <>
          <Navbar />
          <center style={{ color: "wheat"}}>Loading Web3, accounts, and contract...</center>
        </>
      );
    }
    return (
        ...
        <div className="container-main">
          ...
          {!this.state.elStarted & !this.state.elEnded ? (
            <div className="container-item info">
              <center>
                <h3 style={{ color: "white" ,fontSize:"30px"}}>The election has not been initialize.</h3>
                {this.state.isAdmin ? (
                  <p style={{ color: "white"}}>Set up the election.</p>
                ) : (
            ...
            {!this.state.elStarted & !this.state.elEnded ? (
              <div className="container-main">
                ...
                <div className="about-admin">
                  <h3 style={{ color: "black", fontSize: "30px" }}>About Admin</h3>
                    ...
                    <div>
                      ...
                      <label className="label-home">
                        ...
                        <input
                          className="input-home"
                          type="text"
                          placeholder="eg.Head Of Election Commission "
                          {...register("adminTitle", {
                            required: true,
                          })}
                        />
                ...
                <div className="about-election">
                  <h3 style={{ color: "black", fontSize: "30px" }}>About Election</h3>
                  <div className="container-item center-items">
                    <div>
                      <label className="label-home" >
                        Election Title{" "}
