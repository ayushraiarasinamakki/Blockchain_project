        ...
        {!this.state.isElStarted && !this.state.isElEnded ? (
          ...
          <>
            <div className="container-item info">
              <p style={{ color: "white" ,fontSize: "25px"}}>Total registered voters: {this.state.voters.length}</p>
            </div>
            <div className="container-main">
              <h3 style={{color: "black",fontSize: "30px"}}>Registration</h3>
              <small style={{color:"black",fontSize:"20px"}}>Register to vote.</small>
              <div className="container-item">
                <form>
                  <div className="div-li">
                    <label className="label-r" style={{ color: "white" }}>
                      Account Address
                      <input
                        className={"input-r"}
                        type="text"
                  ...
                  <p className="note">
                    ...
                    provided Aadhar Number does not matches the account
                    address registered in the Database.
                  </p>
                  <button
                    className="btn-add"
                    disabled={
  ...
  return (
    <>
      ...
      >
        <table>
          <tr>
            <th style={{ color: "white" }}>Account Address</th>
            <td>{voter.address}</td>
          </tr>
          <tr>
          ...
          <tr>
            <th style={{ color: "white" }}>Aadhar Number</th>
            <td>{voter.phone}</td>
          </tr>
          <tr>
            <th style={{ color: "white" }}>Voted</th>
            <td>{voter.hasVoted ? "True" : "False"}</td>
          </tr>
          <tr>
            <th style={{ color: "white" }}>Verification</th>
            <td>{voter.isVerified ? "True" : "False"}</td>
          </tr>
          <tr>
            <th style={{ color: "white" }}>Registered</th>
      ...
      <>
        <div className="container-list success">
          <table>
            ...
            <tr>
              <th style={{ color: "white" }}>Verified</th>
              <td>{voter.isVerified ? "True" : "False"}</td>
            </tr>
            <tr>
              <th style={{ color: "white" }}>Registered</th>
