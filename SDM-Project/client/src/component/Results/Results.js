        ...
        <div>
          {!this.state.isElStarted && !this.state.isElEnded ? (
            ...
            <div className="container-item attention">
              <center>
                <h3 style={{ color: "white" }}>The election is being conducted at the movement.</h3>
                <p style={{ color: "white" }}>Result will be displayed once the election has ended.</p>
                <p style={{ color: "white" }}>Go ahead and cast your vote {"(if not already)"}.</p>
                <br />
                <Link
                  to="/Voting"
  ...
  return (
    <>
      ...
      <div className="container-main" style={{ borderTop: "1px solid" }}>
        <h2 style={{color: "black",fontSize: "30px"}}>Results</h2>
        <small style={{color:"black",fontSize:"20px"}}>Total candidates: {candidates.length}</small>
        {candidates.length < 1 ? (
          <div className="container-item attention">
            <center style={{ color: "red" }}>No candidates.</center>
          </div>
        ) : (
          <>
            <div className="container-item">
              <table>
                <tr>
                  ...
                  <th style={{ color: "white" }}>Candidate</th>
                  <th style={{ color: "white" }}>Votes</th>
                </tr>
