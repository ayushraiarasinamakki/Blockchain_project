          ...
          {!this.state.isElStarted && !this.state.isElEnded ? (
            ...
            <>
              ...
              <div className="container-main">
                <h2 style={{color: "black",fontSize: "30px"}}>Candidates</h2>
                <small style={{color:"black",fontSize:"20px"}}>Total candidates: {this.state.candidates.length}</small>
            ...
            <>
              <div className="container-item attention">
                <center>
                  <h3 style={{ color: "white" }}>The Election ended.</h3>
                  <br />
                  <Link
                    to="/Results"
